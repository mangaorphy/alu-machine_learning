...
class DeepNeuralNetwork:
    ...
    def __init__(self, nx, layers):
        ...
        Sets:
            ...
            cache: A dictionary to hold all intermediary values of the network (empty at start)
        ...
        # STEP 4: Set public instance attributes

        # L: Number of layers in the neural network
        self.L = len(layers)

        # cache: Dictionary to hold all intermediary values (activations)
        ...
        for l in range(1, self.L + 1):
            ...
            self.weights[f'b{l}'] = np.zeros((output_size, 1))
