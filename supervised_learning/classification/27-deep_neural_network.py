...
import os
"""
Defines a DeepNeuralNetwork class for multiclass classification with multiple hidden layers.
"""


class DeepNeuralNetwork:
    """
    Deep neural network performing multiclass classification with private attributes
    ...
    def forward_prop(self, X):
        ...
        Mathematical Process:
            ...
            2. A[l] = sigmoid(Z[l])         (sigmoid activation function)
    ...
    def gradient_descent(self, Y, cache, alpha=0.05):
        ...
        Mathematical Background:
            ...
            For hidden layers (Layer l, where l < L) with sigmoid:
